...
Le routage repose sur un système de détection hybride (\textit{FormatDetector}) qui combine la précision des signatures binaires avec la flexibilité d'analyses heuristiques :
